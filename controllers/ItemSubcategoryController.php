...
/**
 * ItemSubcategoryController implements the CRUD actions for ItemSubcategory model.
 */
class ItemSubcategoryController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => ItemSubcategory::find()->where(['flag_del' => 0]),
            /*
            'pagination' => [
                'pageSize' => 50
            ],
    ...
    {
        if (($model = ItemSubcategory::findOne(['id' => $id])) !== null) {
            return $model;
        }
